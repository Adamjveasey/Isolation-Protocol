...
public class HUDManager : MonoBehaviour
{
    ...
    private void Update()
    {
        // Switches used sprites for the health bar depending on player max health and wheter or not they has Combat Armour active
        ...
        // Sets current weapon name as displayed name
