...
// Saves and loads game data as binary files for security
// Class made into a sinngleton so functions can be called from any script when necessary
// also so that there are never 2 save systems at once
public static class SaveSystem
{
    ...
    public static PlayerData LoadPlayer( PlayerController player )
    {
        ...
        {
            // Creates a save file if one is not found in the path
    ...
    public static FabricatorData LoadFabricator( FabricatorUpgradeListGenerator droneList, FabricatorUpgradeListGenerator exoSuitList, FabricatorStoreProduct[] weaponList )
    {
        ...
        {
            // Creates a save file if one is not found in path
