...
public class EnemySpawner : MonoBehaviour
{
    ...
    // Increases number of dead enemies and removes them from the spawned enemy list
    ...
    // Spawns a random enemy layout from predetermined list of layouts
    public void SpawnRandomEnemyLayout()
    {
        ...
        {
            // Spawns enemies in random positions within the determined radius from the Enemy Spawner
        ...
        {
            // Spawns enemies in positioned spawn points around Enemy Spawner
            for ( int i = 0; i < m_enemyLayouts[randomLayout].m_enemies.Length; i++ )
            {
    ...
    public void SpawnRandomEnemies()
    {
        ...
        if ( m_randomizePositions )
        {
            ...
            for ( int i = 0; i < numberOfEnemies; i++ )
            {
                ...
                // Gets a random value from 0 to 1 to act as percentage chance of enemy spawn rarity
